  ...
  <ul class="navbar-nav ml-auto">
    <li class="nav-item dropdown user-menu">
      <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        <img src="<?= cekFoto($_SESSION['foto_user'], 'uploads/user'); ?>" class="user-image" alt="User Image" />
      </a>
      <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        <!-- User image -->
        <li class="user-header bg-primary">
          <img src="<?= cekFoto($_SESSION['foto_user'], 'uploads/user'); ?>" class="img-circle elevation-2" alt="User Image" />
...
<aside class="main-sidebar sidebar-light-primary elevation-4 sidebar-no-expand">
  ...
  <a href="<?= $df['home']; ?>" class="brand-link bg-primary">
    ...
    <span class="brand-text font-weight-light">PT. Indotama Laut Lestari</span>
  </a>
